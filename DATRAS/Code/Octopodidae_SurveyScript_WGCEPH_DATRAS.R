...
aphias_df$SpeciesName <- ifelse(aphias_df$SpeciesName == "Octopus", "Octopus spp.", aphias_df$SpeciesName)
aphias_df$SpeciesName <- ifelse(aphias_df$SpeciesName == "Eledone", "Eledone spp.", aphias_df$SpeciesName)
